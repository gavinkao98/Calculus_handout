...
> 中立記錄。direction_layer 流程（[`../../../CONTENT_DIRECTION.md`](../../../CONTENT_DIRECTION.md)）在**整章 6 節**上的逐節端到端跑。
...
## §1.3–§1.6
⏳ 待跑（六階照 CONTENT_DIRECTION.md，人閘 ①-verify／③／⑥ 逐節保留）。
...
- **下一步（換機接續）**：從 **§1.3 函數的極限** 的 ① intake 開始（讀手稿 p.9–11 → seed_s13.md → ①-verify）。流程權威見 [`../../../CONTENT_DIRECTION.md`](../../../CONTENT_DIRECTION.md)、契約見本檔上方各節記錄。
