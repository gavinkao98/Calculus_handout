...
def check_scenes(meta: dict, scenes: list[dict]) -> list[str]:
    """Return (severity, message) tuples for the given content scenes.
    'error' = stacked-prose size mismatch (aborts render); 'warn' = teaching
    prose rendered in muted (too faint)."""
