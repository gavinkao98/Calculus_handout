...
(``tools/manim_templates/layout.py``). Provides a ``SceneLayout`` that maps
Manim coordinate space into named zones (header, primary, support, progress)
so that individual templates can position content without hard-coding magic
numbers.
"""
