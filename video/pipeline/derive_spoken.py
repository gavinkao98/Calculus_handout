...
def main() -> int:
    ...
    # Stamp BOTH generation inputs (canonical + spoken source) so make.py/tts.py can
    # refuse a stale generated deck (F2 drift guard); LF-normalized hash inside stamp_for.
