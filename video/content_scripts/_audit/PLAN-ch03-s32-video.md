...
- [ ] 通讀 [`sec-3-2.html`](../../../handout/fragments/ch03/sec-3-2.html) 與 §3.1 內容稿範本（已讀）。
- **驗證點：** 範本可讀、§3.2 編號契約掌握。
