...
>
> **相關文件：** 視覺系統見 [`DESIGN.md`](DESIGN.md) 與 [`pipeline/visuals/theme.py`](pipeline/visuals/theme.py)（Direction D 版面＋Times 字型）；講義（HTML handout kit）的撰寫契約與環境詞彙見 [`../handout/_dev-archive/general/CONTRACT-html-writing.md`](../handout/_dev-archive/general/CONTRACT-html-writing.md)；本產線總覽見 [`README.md`](README.md)。
>
