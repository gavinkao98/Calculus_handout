...
% NOTE(習題本素材): 手稿本章附 4 道 homework——(1) f'=0 on (a,b) ⟹ f 為常數;
% (2) ln a + ln b = ln(ab); (3) 連續 g:R→R+ 滿足 g(x)g(y)=g(x+y) 且 g(1)=e ⟹ g=e^x
% (Cauchy functional equation); (4) a>0 時定義 a^x = e^{x ln a} 並驗證指數律。
% 講義本體不收習題(CONTENT_SPEC §14, 2026-06-12 定案);此清單保留給獨立習題本輪次。
