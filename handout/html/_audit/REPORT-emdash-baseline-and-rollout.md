...
| ch01 | 54 | 5,792 | 9.3 | 39 | 22 | 38 | 38 | ⏳ 待做（~~舊尺 5.5~~） |
...
**目標值 `T_can` ≤ 3.0/1000（canonical stream）。** 依據＝canonical 重測的真實教材基準（§1）：mooculus 0.0、APEX V5 0.5、CLP1 3.1。目標貼 CLP1（五本中最口語者）的上緣；appB 的 2.2 落在 APEX 與 CLP1 之間，是現行唯一達標單元。
