...
已完成（2026-07-26 合併回收後，11 個單元中 **7 個達標**）：appB 2.2、ch01 2.1、ch02 0.9、ch03 1.6、ch04 2.3、ch05 0.8、ch07 1.6——全部落在 APEX（0.5）與 CLP1（3.1）之間，逐輪紀錄見各章 `REVIEW-ch<NN>-plain-applied.html`。ch01 §1.4 **刻意不動**，作為手稿章（真人逐字）的假陽性基準。

**剩餘：** ch06（進行中，走查與 Codex gate-2 已產出、尚未提交）＋ appA 18.8／appC 17.8／appD 13.2 三個附錄。
...
~~ch07 (128) → ch02 (95) → ch05 (86) → ch04 (71) →~~ **ch06 剩餘節 (55，進行中)** → **appA (49)** → ~~ch03 (42) → ch01 (37) →~~ **appC (20)** → **appD (14)**。
