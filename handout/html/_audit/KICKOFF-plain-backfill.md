...
~~**ch06 剩餘節另有一筆**：§6.1 有兩段 ≥150 詞（最長 169 詞），是段落標準上線後第一個該處理的離群。~~（已隨 ch06 合併 sweep 處理——§6.1 Caution 159→32/48/75、§6.5 章末摘要 167→63/61/43、§6.1 章 lead 152→133；見 [`REPORT-emdash-baseline-and-rollout.md`](REPORT-emdash-baseline-and-rollout.md) 排序表 ch06 列。）
