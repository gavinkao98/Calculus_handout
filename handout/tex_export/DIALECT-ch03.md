...
> 盤點對象＝`fragments/ch03/sec-3-{1,2,3}.html`（880 行）＋ `chapter3-print-standalone.html` 的 `FIGS`。
> 盤點日：2026-07-15。重跑：`python handout/tex_export/dialect_inventory.py ch03`。

## 1. 摘要

- **34 種 tag＋class 組合**，全部落在 [`../CONTRACT-html-writing.md`](../CONTRACT-html-writing.md) 的封閉方言內，**零意外標記**。
...
| `p em`「First reading:／Proof track:」 | ch03 無 reading-track 段落（只在 `fragments/ch01/sec-1-6.html`） |
...
*M-P0 完成。M-P1–P4 見 [`_review/REVIEW-latex-pilot-ch03.html`](_review/REVIEW-latex-pilot-ch03.html)。*
