...
% ============================================================
% chapter1.tex — ch01 出版成品（自動產生，勿手改）
% 產生：cd handout/latex && python make_dist.py ch01
%   內容源＝handout/html/fragments/ch01/（fragment 唯讀；數學逐位元組 pass-through）
...
\end{envremark}
\begin{figureblock}
\includegraphics[width=72.35mm]{ch01/figs/hlt-1}\hspace{6mm}\includegraphics[width=72.35mm]{ch01/figs/hlt-2}
...
\begin{figureblock}
\includegraphics[width=64.03mm]{ch01/figs/one-sided-infinite-1}\hspace{6mm}\includegraphics[width=64.03mm]{ch01/figs/one-sided-infinite-2}\hspace{6mm}\includegraphics[width=64.03mm]{ch01/figs/one-sided-infinite-3}\hspace{6mm}\includegraphics[width=64.03mm]{ch01/figs/one-sided-infinite-4}
