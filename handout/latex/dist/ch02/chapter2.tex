...
% ============================================================
% chapter2.tex — ch02 出版成品（自動產生，勿手改）
% 產生：cd handout/latex && python make_dist.py ch02
%   內容源＝handout/html/fragments/ch02/（fragment 唯讀；數學逐位元組 pass-through）
