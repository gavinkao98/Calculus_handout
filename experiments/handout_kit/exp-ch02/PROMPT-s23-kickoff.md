...
3. experiments/handout_kit/exp-ch02/sec-2-1.html 與 sec-2-2.html — 兩個完成的校準成品，
   照它們的結構／密度／手動編號／交叉引用寫法。
4. experiments/handout_kit/exp-ch02/brief_s21.md、brief_s22.md — brief 範例（九欄怎麼填）。
...
7. seed：experiments/handout_kit/exp-ch02/seed_ch02_s3.md（手稿 pp. 6–7）。
...
- 截圖自驗：node experiments/handout_kit/_render/shot.mjs
  "http://localhost:8753/chapter2-screen.html" experiments/handout_kit/_render/s23 full
