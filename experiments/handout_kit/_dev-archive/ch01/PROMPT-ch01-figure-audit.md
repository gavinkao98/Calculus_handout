...
## 依序讀（建立脈絡）
1. experiments/handout_kit/example-ch01/figures.js
   ← 全部圖的 JS 定義（Chapter 1 共 13 幅），逐幅讀
2. experiments/handout_kit/example-ch01/sec-1-1.html
   experiments/handout_kit/example-ch01/sec-1-2.html
   experiments/handout_kit/example-ch01/sec-1-3.html
   experiments/handout_kit/example-ch01/sec-1-4.html
   experiments/handout_kit/example-ch01/sec-1-5.html
   experiments/handout_kit/example-ch01/sec-1-6.html
